...
ams.training <- ams.training%>%
  dplyr::select(price, postcode4, geometry,highrise_nn3,greenroof_nn3,wallart_nn3,market_nn3,swimming_nn3  ) 
...
reg.training <- 
  lm(price ~ ., data = as.data.frame(ams.training) %>% 
                             dplyr::select(price, highrise_nn3,greenroof_nn3,wallart_nn3,market_nn3,swimming_nn3 ))
